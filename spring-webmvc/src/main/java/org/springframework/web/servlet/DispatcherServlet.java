...
public class DispatcherServlet extends FrameworkServlet {
	...
	protected void initStrategies(ApplicationContext context) {
		...
		/**
		 * 支持Request映射的HandlerMappings的舒适化
		 */
	...
	private void initHandlerMappings(ApplicationContext context) {
		...
		if (this.detectAllHandlerMappings) {
			 ...
			 * 查找所有的HandlerMapping Bean
			 * 这个Bean可以在当前的DispatcherServlet的IoC容器中 也可能在其双亲上下文中
			 * 默认从所有的IoC容器中获取
			 */
		 ...
		 * 如果没有找到HandlerMappings 需要为Servlet设定默认的HandlerMappings
		 * 这些默认的设置在DispatcherServlet.properties
		 */
	...
	protected void render(ModelAndView mv, HttpServletRequest request, HttpServletResponse response) throws Exception {
		 ...
		 * 从request中读取locale信息 设置response的locale值
		 */
		Locale locale =
		...
		if (viewName != null) {
			 ...
			 * ModelAndView对象中可能已经直接包含了View对象 可以直接使用
			 */
			view = mv.getView();
			if (view == null) {
